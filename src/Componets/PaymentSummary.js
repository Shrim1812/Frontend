...
function PaymentForm() {
    ...
    const fetchRegistrationFees = async (companyId) => {
        try {
            const response = await fetch(`https://backend-6hdo.onrender.com/Ohkla/getRegistrationFee/${companyId}`, {
                method: 'GET',
            });
    ...
    useEffect(() => {
        axios.get("https://backend-6hdo.onrender.com/Ohkla/getCompany")
            .then((res) => setCompanies(res.data))
            .catch((err) => console.error("Error fetching companies:", err));

        axios.get("https://backend-6hdo.onrender.com/Ohkla/getYear")
            .then((res) => {
        ...
        try {
            ...
            if (paymentType === "Annual") {
                ...
                if (data && Object.keys(data).length > 0) {
                    ...
                    const resMember = await axios.get(`https://backend-6hdo.onrender.com/Ohkla/getMemberById/${selectedId}`);
       ...
       const current = parseInt(localStorage.getItem("receiptCounter") || "101", 10);
        ...
        try {
            if (paymentType === "Annual") {
                ...
                await axios.post("https://backend-6hdo.onrender.com/Ohkla/addPayment", {
                ...
                const receiptRes = await axios.post("https://backend-6hdo.onrender.com/Ohkla/ReceiptOfPayment", receiptPayload);
                ...
                try {
                    ...
                    const response = await axios.put("https://backend-6hdo.onrender.com/Ohkla/updateAnnualPayment", payload);
                ...
                // ✅ Send to ExtraDetail
                const response = await axios.post("https://backend-6hdo.onrender.com/Ohkla/ExtraDetail", {
                    MembershipID: parseInt(selectedId),
