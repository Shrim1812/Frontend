...
const UserManagementTable = () => {
    ...
    const fetchUsers = async () => {
        const res = await axios.get("https://backend-6hdo.onrender.com/Ohkla/getAllUsers");
    ...
    const handleSave = async () => {
        try {
            await axios.post("https://backend-6hdo.onrender.com/Ohkla/updateUserByAdmin", {
    ...
    const handleChangePassword = async (user) => {
        ...
        try {
            await axios.post("https://backend-6hdo.onrender.com/Ohkla/changePassword", {
                email: user.Email,
                newPassword: newPass,
            });
